...
class Command(BaseCommand):
        def _create(self):
                ...
                with open(file_path, 'w+', encoding='utf-8') as databaseEntriesAsCsv:
                        fieldnames = [
                                'Student_ID','Name','Campus','Attempt','Level','Status','LastChangedDate','Description','Level1Comment','Level2Comment','NewStation','NatureOfQuery','Publish','LastChangedDate',
                ...
                with open(file_path, mode='a', encoding='iso-8859-1') as databaseEntriesAsCsv:
                        ...
                        for student in UserProfile.objects.all() :
                                ...
                                try:
                                        ...
                                        l=1
                                try:
                                        appstatus = ApplicationStatus.objects.get(student_id = student)
                                        k=0
                                except:
                                        pass                
                                        k=1
                                try:
                                        informativeQueryFormOb = InformativeQueryForm.objects.get(student_id = student)
                                        j=0
                                except:
                                        pass     
                                        j=1
                                ...
                                if(k==0):
                                        ...
                                        # toWrite.append((appstatus.lastChangedDate).encode('utf-8'))
