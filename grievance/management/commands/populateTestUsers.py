...
class Command(BaseCommand):
  def _create(self):
    for i in range(10):
      ...
      (user, created) = User.objects.get_or_create(username="user"+str(i),password=password)
    ...
    (user, created) = User.objects.get_or_create(username="cmo",password=password)
    ...
    (user, created) = User.objects.get_or_create(username="ad",password=password)
