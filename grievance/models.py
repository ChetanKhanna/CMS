...
class ApplicationStatus(models.Model):
	...
	level1Comment = models.CharField(max_length = 5000, blank=True)
	level2Comment = models.CharField(max_length = 5000, blank=True)
	newStation = models.CharField(max_length = 5000, blank=True)
