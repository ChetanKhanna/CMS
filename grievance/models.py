...
class GrievanceForm(models.Model):
	...
	preferenceNumberOfAllocatedStation = models.IntegerField(default = 2) #TODO remove blank true
...
class InformativeQueryForm(models.Model):
	...
	campus = models.IntegerField(default = 0)
	lastChangedDate = models.DateTimeField(auto_now_add=True)
	# allocatedStation = models.CharField(max_length = 500, blank = True) TODO
	# preferenceNumberOfAllocatedStation = models.IntegerField(blank = True)
